...
SSB, $F$, $\frac{\text{B}}{\text{B}_{40\%}}$, $\frac{F}{F_{40\%}}$, and $R$ were estimated without significant bias in self-tests, although m1 and m2 exhibited bias in SSB and $\frac{F}{F_{40\%}}$ when fit to data simulated from m3 (Figs. \ref{fig:rel-error-butterfish-m} and S15–S16).
