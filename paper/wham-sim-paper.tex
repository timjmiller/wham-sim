...
Synthesis is similar: allow 2D AR1 random effects on \(s_{a,y}\) instead
of the parameters, and then estimate \(\sigma_s\) by an iterative tuning
algorithm (Xu et al., 2019). It is unclear whether estimating
time-varying selectivity as random effects produces different results or
an improvement over using time blocks, or if there are advantages to
