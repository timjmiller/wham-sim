...
was held constant, optimal \emph{M} random effects resulted in lower
\emph{M} in some ages and years and higher \emph{M} in others.
...
\emph{R} in some years (compare locations of points between Fig.
...
m3. For Georges Bank haddock, the variance and correlation parameters
...
award at the NEFSC. We thank Chris Melrose for updating the Cold Pool
Index with data through 2018, using code originally written by Jon Hare.
NOAA Fish \& Climate grant number ??.
