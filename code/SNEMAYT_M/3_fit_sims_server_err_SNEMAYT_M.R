...
saveRDS(results, file=paste0("results_SNEMAYT_M_om",om,"_em",em,".rds"))	
saveRDS(sdreps, file=paste0("sdreps_SNEMAYT_M_om",om,"_em",em,".rds"))	
saveRDS(reps, file=paste0("reps_SNEMAYT_M_om",om,"_em",em,".rds"))	
