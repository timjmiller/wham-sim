...
# source("/home/bstock/Documents/ms/wham-sim/code/v2_fits/plot_NAAdevs.R")
...
for(j in 1:length(ids)){
  ...
  png(file.path(plots_dir,paste0("NAAdevs_",ids[j],".png")), width=6, height=7, units='in', res=300)
  print(g)
  dev.off()
}
