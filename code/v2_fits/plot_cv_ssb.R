...
# source("/home/bstock/Documents/ms/wham-sim/code/v2_fits/plot_cv_ssb.R")
...
res_dir=file.path(getwd(),"results","v2_fits")
  ...
  # png(file.path(plots_dir, "rel_cv_naa.png"), width=5, height=5, res=300, units='in')
  # print(ggplot(df, aes(x=Model, y=mean_rel_cv, shape=Stock)) +
  ...
  png(file.path(plots_dir, "rel_cv_naa_boxplot.png"), width=3.75, height=5, res=300, units='in')
