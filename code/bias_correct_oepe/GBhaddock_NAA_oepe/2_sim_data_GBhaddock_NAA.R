...
# source(here::here("code","bias_correct_oepe","GBhaddock_NAA_oepe","2_sim_data_GBhaddock_NAA.R"))
...
res_dir <- here("results","bias_correct_oepe","GBhaddock_NAA_oepe")
out_dir <- here("data","simdata","bias_correct_oepe","GBhaddock_NAA_oepe")
