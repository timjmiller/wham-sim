...
# for(m in 1:n.mods){
	...
	for(i in 1:n.sim){
		...
		if(em == 1) input1$data$selblock_models_re <- c(1,1,1,1)
		if(em == 2) input1$data$selblock_models_re <- c(2,1,1,1)
		if(em == 3) input1$data$selblock_models_re <- c(5,1,1,1)		
		...
		if(em == 1) input2$data$selblock_models_re <- c(1,1,1,1)
		if(em == 2) input2$data$selblock_models_re <- c(2,1,1,1)
		if(em == 3) input2$data$selblock_models_re <- c(5,1,1,1)
