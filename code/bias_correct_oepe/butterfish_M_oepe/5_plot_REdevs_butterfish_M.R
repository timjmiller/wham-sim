...
# source("/home/bstock/Documents/ms/wham-sim/code/bias_correct_oepe/butterfish_M_oepe/5_plot_REdevs_butterfish_M.R")
...
plots_dir <- here("plots","bias_correct_oepe","butterfish_M")
...
png(file.path(plots_dir,"8_REdevs_butterfish_M.png"), width=6, height=5, units='in', res=300)
print(ggplot(df.plot, ggplot2::aes(x=Year, y=Age, fill=M)) +
      geom_tile() +
