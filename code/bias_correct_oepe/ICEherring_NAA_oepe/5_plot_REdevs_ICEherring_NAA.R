...
# source("/home/bstock/Documents/ms/wham-sim/code/bias_correct_oepe/ICEherring_NAA_oepe/5_plot_REdevs_ICEherring_NAA.R")
...
n.mods = 4
res_dir <- here("results","bias_correct_oepe","ICEherring_NAA_oepe")
plots_dir <- here("plots","bias_correct_oepe","ICEherring_NAA")
...
png(file.path(plots_dir,"8_REdevs_ICEherring_NAA.png"), width=7, height=7, units='in', res=300)
