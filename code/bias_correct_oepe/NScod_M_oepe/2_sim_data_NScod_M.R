...
# source(here::here("code","bias_correct_oepe","NScod_M_oepe","2_sim_data_NScod_M.R"))
...
res_dir <- here("results","bias_correct_oepe","NScod_M_oepe")
out_dir <- here("data","simdata","bias_correct_oepe","NScod_M_oepe")
dir.create(out_dir, showWarnings=FALSE)

# Simulate data
n.mods <- 2 # only do m1 and m2 bc m3 didn't converge
n.sim <- 100
...
for(m in 1:n.mods) mods1[[m]]$env$data$simulate_state <- rep(0,4) # simulate_state = 0 (fixed M, obs error only)
