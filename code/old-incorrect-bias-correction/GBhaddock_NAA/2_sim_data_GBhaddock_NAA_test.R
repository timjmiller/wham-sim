...
# source(here::here("code","GBhaddock_NAA","2_sim_data_GBhaddock_NAA_test.R"))
...
out_dir <- here("data","simdata","GBhaddock_NAA")
...
m=3
mod = readRDS(mod.list[m])
mod$env$data$simulate_state <- rep(0,4)
