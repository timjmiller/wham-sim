...
# source("/home/bstock/Documents/ms/wham-sim/code/GBhaddock_NAA/4_results_GBhaddock_NAA.R")
...
res_dir <- here("results","GBhaddock_NAA")
plots_dir <- here("plots","GBhaddock_NAA")
...
simdata <- lapply(1:4, function(x) readRDS(here("data","simdata","GBhaddock_NAA",paste0("simdata_om",x,".rds"))))
