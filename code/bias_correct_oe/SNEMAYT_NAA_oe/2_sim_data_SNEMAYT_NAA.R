...
# source(here::here("code","bias_correct_oe","SNEMAYT_NAA_oe","2_sim_data_SNEMAYT_NAA.R"))
...
res_dir <- here("results","bias_correct_oe","SNEMAYT_NAA_oe")
out_dir <- here("data","simdata","bias_correct_oe","SNEMAYT_NAA_oe")
