...
# source(here::here("code","bias_correct_oe","butterfish_M_oe","2_sim_data_butterfish_M.R"))
...
res_dir <- here("results","bias_correct_oe","butterfish_M_oe")
out_dir <- here("data","simdata","bias_correct_oe","butterfish_M_oe")
